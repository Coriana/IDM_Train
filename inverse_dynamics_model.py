...
class IDMAgent:
    ...
    def _video_action_to_agent(self, minerl_action_transformed, to_torch=False):
        """
        ...
        minerl_action = [self.action_transformer.env2policy(frame) for frame in minerl_action_transformed]
